...
class LangEmbLeNetLenFreeVq(BaseNet):
    ...
    def __init__(self):
        ...
        self.fc0 = nn.Linear(6, 512, bias=False)
...
class LangEmbLeNetLenFreeVqAutoencoder(BaseNet):
    ...
    def __init__(self):
        ...
        self.fc2 = nn.Linear(512, 6, bias=False)
